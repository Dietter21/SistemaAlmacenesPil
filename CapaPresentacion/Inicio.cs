...
namespace CapaPresentacion
{
    public partial class Inicio : Form
    {
        ...
        {
            AbrirFormulario(menusalidas, new frmSalidas(usuarioActual));
        }

        private void submenuverdetalleventa_Click(object sender, EventArgs e)
        {
            AbrirFormulario(menusalidas, new frmDetalleSalida());
        }

        private void submenuregistrarcompra_Click(object sender, EventArgs e)
        {
            AbrirFormulario(menuentradas, new frmEntradas(usuarioActual));
        }
        ...
        {
            AbrirFormulario(menureportes, new frmReporteEntradas());
        }
        ...
        private void menuSalidas_Click(object sender, EventArgs e)
        {
