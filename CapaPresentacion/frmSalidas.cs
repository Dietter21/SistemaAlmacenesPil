...
namespace CapaPresentacion
{
    public partial class frmSalidas : Form
    {
        ...
        public frmSalidas(Usuario oUsuario = null)
        {
            _Usuario = oUsuario;
            InitializeComponent();
        }
        ...
        private void btnbuscarproducto_Click(object sender, EventArgs e)
        {
            using (var modal = new mdProducto())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    txtprecio.Text = modal._Producto.PrecioSalida.ToString("0.00");
        ...
        private void txtcodproducto_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                ...
                if (oProducto != null)
                {
                    ...
                    txtprecio.Text = oProducto.PrecioSalida.ToString("0.00");
        ...
        private void btncrearventa_Click(object sender, EventArgs e)
        {
            ...
            bool respuesta = new CN_Salida().Registrar(oVenta, detalle_venta, out mensaje);
